      ...
      <footer className="footer__section bg__black">
        <div className="container-fluid">
            <div className="main__footer d-flex justify-content-between">
                <div className="footer__widget footer__widget--width">
                    ...
                    <div className="footer__widget--inner">
                        <p className="footer__widget--desc text-ofwhite mb-20">Lorem ipsum dolor sit amet, consectetur adipisici ti elit  seddo eiusmod tempor incididunt utlabore.</p>
            ...
            <div className="footer__bottom d-flex justify-content-between align-items-center">
                <p className="copyright__content text-ofwhite m-0">Copyright © 2022 <a className="copyright__content--link" href="index.html">TOPKLAZZIC</a> .</p>
