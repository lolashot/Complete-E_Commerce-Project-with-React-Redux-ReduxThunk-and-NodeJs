                ...
                <div class="row row-cols-lg-2 row-cols-md-2">
                  <div class="col">
                    <img
                      ...
                      src={
                        require("../../assets/img/product/product2.png").default
                      }
                      alt="product-img"
                      width="100"
                      height="50"
                      ...
                      <form action="#">
                        ...
                        <div className="product__variant">
                          <div className="product__variant--list mb-15">
                            <div className="variant__input--fieldset weight">
                              ...
                              <span id="cart_btn" className=""></span>
                            </div>
                          </div>
                        ...
                        <div class="guarantee__safe--checkout">
                          ...
                          <img
                            ...
                            src="assets/img/other/safe-checkout.png"
                            alt="Payment Image"
                          />
                        </div>
                      </form>
                ...
                <div class="row row-cols-1">
                  <div class="col">
                    <ul class="product__details--tab d-flex mb-30">
                      <li
                        class="product__details--tab__list active"
                        data-toggle="tab"
                      ...
                      <li
                        class="product__details--tab__list"
                        data-toggle="tab"
                        data-target="#reviews"
                      >
                        Product Reviews
                          ...
                          <div class="product__tab--content">
                            <div class="product__tab--content__step mb-30">
                              ...
                              <p class="product__tab--content__desc">
                                ...
                                Ducimus dolore accusamus impedit ipsum maiores,
                                ea iusto temporibus numquam eaque mollitia
                                fugiat laborum dolor tempora eligendi voluptatem
                                quis necessitatibus nam ab?
                              </p>
                            </div>
                            <div class="product__tab--content__step">
                              ...
                              <ul>
                                <li class="product__tab--content__list">
                                  <svg
                                    class="product__tab--content__list--icon"
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="22.51"
                                    height="20.443"
                                    viewBox="0 0 512 512"
                        ...
                        <div id="reviews" class="tab_pane">
                          <div class="product__reviews">
                            <div class="product__reviews--header">
                              ...
                              <a
                                class="actions__newreviews--btn primary__btn"
                                href="#writereview"
                              >
                                Write A Review
                              </a>
                            ...
                            <div
                              id="writereview"
                              class="reviews__comment--reply__area"
                            >
                              <form action="#">
